-- Avoid_Interface_targettarget_ConfigUI.lua
-- Baut die "targettarget"-Seite im gemeinsamen Avoid Interface Config-Fenster
AI       = AI or {}
AI.ConfigUI = AI.ConfigUI or {}

-- Stellt sicher, dass AI_Config.modules[moduleKey] existiert
local function GettargettargetEntry(moduleKey)
...
local function GettargettargetModule()
    if AI and AI.modules and type(AI.modules.targettarget) == "table" then
        return AI.modules.targettarget
    end
end

local function ApplytargettargetLayout()
    local m = GettargettargetModule()
    if m and m.ApplyLayout then
        m.ApplyLayout()
    elseif AI and AI.RefreshModule then
        AI.RefreshModule("targettarget")
    end
end


local function BuildtargettargetConfigPage(page, moduleKey, labelText, helpers)
    ...
    do
        ...
        presetDropdown = CreateSimpleDropdown(
            "AI_targettarget_PresetDD",   -- Name (STRING!)
            page,                   -- Parent
            "Preset",               -- Label
            presetItems,            -- Items
    ...
    -------------------------------------------------
    -- Move- und Reset-Buttons (nur targettarget-Frame)
    -------------------------------------------------
    ...
    moveButton:SetScript("OnClick", function(self)
        ...
        -- wie beim targettarget: sobald der Move-Mode umgeschaltet wird,
        -- gilt die Seite als geändert -> "Speichern"-Button aktiv
        if page.SetDirty then
            page.SetDirty(true)
        end
    end)
    ...
    resetPosButton:SetScript("OnClick", function()
        ...
        -- Layout neu anwenden (targettarget, nicht targettarget)
        ...
        -- Änderungen markieren -> "Speichern" wird aktiv
        if page.SetDirty then
            page.SetDirty(true)
        end
    end)
    ...
    -- targettarget-spezifische Controls
    ...
    -- NEU: Text-Classcolor-Checkboxen
    local nameClassColorCheck
    local hpTextClassColorCheck
    local mpTextClassColorCheck
    local lvlTextClassColorCheck
    ...
    local debuffsEnableCheck, debuffsSizeSlider, debuffsMaxSlider, debuffsPerRowSlider, debuffsAnchorDD, debuffsXSlider, debuffsYSlider, debuffsGrowDD
        ...
        borderSizeSlider = CreateSliderWithInput(
            "AI_targettarget_BorderSizeSlider",
            page,
            "Rahmen-Dicke",
            1, 16, 1,
            borderStyleDD,
        ...
        -- BorderSize je nach Stil aktiv/deaktivieren (für targettarget)
        local function UpdateBorderSizeSliderEnabled(style)
            local cfg = GettargettargetEntry(moduleKey)

            style = style or (cfg and cfg.borderStyle) or "PIXEL"
        ...
        nameXSlider = CreateSliderWithInput(
            "AI_targettarget_NameXOffsetSlider",
            page,
        ...
        nameYSlider = CreateSliderWithInput(
            "AI_targettarget_NameYOffsetSlider",
            page,
        ...
        nameSizeSlider = CreateSliderWithInput(
            "AI_targettarget_NameSizeSlider",
            page,
        ...
        hpXSlider = CreateSliderWithInput(
            "AI_targettarget_HPXOffsetSlider",
            page,
            "X-Offset HP-Text",
            -200, 200, 1,
            hpModeDD,
        ...
        hpYSlider = CreateSliderWithInput(
            "AI_targettarget_HPYOffsetSlider",
            page,
            "Y-Offset HP-Text",
            -200, 200, 1,
            hpXSlider,
        ...
        mpXSlider = CreateSliderWithInput(
            "AI_targettarget_MPXOffsetSlider",
            page,
            "X-Offset Mana-Text",
            -200, 200, 1,
            mpModeDD,
        ...
        mpYSlider = CreateSliderWithInput(
            "AI_targettarget_MPYOffsetSlider",
            page,
            "Y-Offset Mana-Text",
            -200, 200, 1,
            mpXSlider,
        ...
        lvlXSlider = CreateSliderWithInput(
            "AI_targettarget_LvlXOffsetSlider",
            page,
            "X-Offset Level-Text",
            -200, 200, 1,
            lvlShow,
        ...
        lvlYSlider = CreateSliderWithInput(
            "AI_targettarget_LvlYOffsetSlider",
            page,
            "Y-Offset Level-Text",
            -200, 200, 1,
            lvlXSlider,
        ...
        leaderIconCheck:SetPoint("TOPLEFT", iconHeader, "BOTTOMLEFT", 0, -32)
        ...
        leaderIconSizeSlider = CreateSliderWithInput(
            "AI_targettarget_LeaderIconSizeSlider",
            page,
            "Leader-Icon Größe",
            8, 64, 1,
            leaderIconCheck,
        ...
        leaderIconXSlider = CreateSliderWithInput(
            "AI_targettarget_LeaderIconXOffsetSlider",
            page,
        ...
        leaderIconYSlider = CreateSliderWithInput(
            "AI_targettarget_LeaderIconYOffsetSlider",
            page,
        ...
        leaderIconAnchorDD = CreateSimpleDropdown(
            "AI_targettarget_LeaderIconAnchorDD",
            page,
            "Leader-Icon Anker",
            anchorItems,
            leaderIconYSlider,
        ...
        raidIconCheck.text:SetText("Raidtargettarget-Icon anzeigen")

        raidIconSizeSlider = CreateSliderWithInput(
            "AI_targettarget_RaidIconSizeSlider",
            page,
            "Raidtargettarget-Icon Größe",
            8, 64, 1,
            raidIconCheck,
            -24
        )
        ...
        raidIconXSlider = CreateSliderWithInput(
            "AI_targettarget_RaidIconXOffsetSlider",
            page,
            "Raidtargettarget-Icon X-Offset",
            -200, 200, 1,
            raidIconSizeSlider,
            -24
        )
        ...
        raidIconYSlider = CreateSliderWithInput(
            "AI_targettarget_RaidIconYOffsetSlider",
            page,
            "Raidtargettarget-Icon Y-Offset",
            -200, 200, 1,
            raidIconXSlider,
            -24
        )
        ...
        raidIconAnchorDD = CreateSimpleDropdown(
            "AI_targettarget_RaidIconAnchorDD",
            page,
            "Raidtargettarget-Icon Anker",
            anchorItems,
            raidIconYSlider,
            -24
        )
        ...
        aurasHeader:SetPoint("TOPLEFT", raidIconAnchorDD, "BOTTOMLEFT", 0, -32)
        ...
        buffsSizeSlider = CreateSliderWithInput(
            "AI_targettarget_BuffsSizeSlider",
            page,
            "Buff-Icon Größe",
            8, 64, 1,
            buffsEnableCheck,
        ...
        buffsMaxSlider = CreateSliderWithInput(
            "AI_targettarget_BuffsMaxSlider",
            page,
            "Max. Buffs",
            1, 40, 1,
            buffsSizeSlider,
        ...
        buffsPerRowSlider = CreateSliderWithInput(
            "AI_targettarget_BuffsPerRowSlider",
            page,
            "Buffs pro Reihe",
            1, 40, 1,
            buffsMaxSlider,
        ...
        buffsXSlider = CreateSliderWithInput(
            "AI_targettarget_BuffsXOffsetSlider",
            page,
            "Buff X-Offset",
            -400, 400, 1,
            buffsAnchorDD,
        ...
        buffsYSlider = CreateSliderWithInput(
            "AI_targettarget_BuffsYOffsetSlider",
            page,
            "Buff Y-Offset",
            -400, 400, 1,
            buffsXSlider,
        ...
        debuffsSizeSlider = CreateSliderWithInput(
            "AI_targettarget_DebuffsSizeSlider",
            page,
            "Debuff-Icon Größe",
            8, 64, 1,
            debuffsEnableCheck,
        ...
        debuffsMaxSlider = CreateSliderWithInput(
            "AI_targettarget_DebuffsMaxSlider",
            page,
            "Max. Debuffs",
            1, 40, 1,
            debuffsSizeSlider,
        ...
        debuffsPerRowSlider = CreateSliderWithInput(
            "AI_targettarget_DebuffsPerRowSlider",
            page,
            "Debuffs pro Reihe",
            1, 40, 1,
            debuffsMaxSlider,
        ...
        debuffsAnchorDD = CreateSimpleDropdown(
            "AI_targettarget_DebuffsAnchorDD",
            page,
        ...
        debuffsXSlider = CreateSliderWithInput(
            "AI_targettarget_DebuffsXOffsetSlider",
            page,
            "Debuff X-Offset",
            -400, 400, 1,
            debuffsAnchorDD,
        ...
        debuffsYSlider = CreateSliderWithInput(
            "AI_targettarget_DebuffsYOffsetSlider",
            page,
            "Debuff Y-Offset",
            -400, 400, 1,
            debuffsXSlider,
        ...
        -------------------------------------------------
        -- targettarget-Controls am Page-Objekt speichern
        -------------------------------------------------
        ...
        page.nameClassColorCheck   = nameClassColorCheck
        page.hpTextClassColorCheck = hpTextClassColorCheck
        page.mpTextClassColorCheck = mpTextClassColorCheck
        page.lvlTextClassColorCheck = lvlTextClassColorCheck
        ...
        -- targettarget-Controls am Page-Objekt speichern
        -------------------------------------------------
        -- (lass alles vorher Unveränderte stehen, das hier sind nur die relevanten Zeilen)
    ...
    -------------------------------------------------
   page.Init = function()
    local entry = GettargettargetEntry(moduleKey)
    ...
    elseif entry.enabled == nil then
        ...
        check:SetChecked(entry.enabled and true or false)
            ...
            -- Defaults wie im targettarget-Modul
            ...
            -- Klassenfarbe für Texte (neu)
            if entry.nameTextUseClassColor  == nil then entry.nameTextUseClassColor  = false end
            if entry.hpTextUseClassColor    == nil then entry.hpTextUseClassColor    = false end
            if entry.mpTextUseClassColor    == nil then entry.mpTextUseClassColor    = false end
            if entry.levelTextUseClassColor == nil then entry.levelTextUseClassColor = false end
            ...
            -- Icon-Defaults (nur für Config-UI, eigentliche Logik ist im targettarget-Modul)
    ...
    check:SetScript("OnClick", function(self)
        ...
        -- Buff-Options (targettarget, nicht targettarget!)
    ...
    if moveButton then
        moveButton:SetScript("OnClick", function(self)
            ...
            if cfg.movable then
                self:SetText("Beenden")
                if AI and AI.modules and AI.modules.targettarget and AI.modules.targettarget.StartMovingMode then
                    AI.modules.targettarget.StartMovingMode()
                end
            else
                self:SetText("Frame bewegen")
                if AI and AI.modules and AI.modules.targettarget and AI.modules.targettarget.StopMovingMode then
                    AI.modules.targettarget.StopMovingMode()
                end
            end
    ...
    if resetPosButton then
        resetPosButton:SetScript("OnClick", function(self)
            AI_Config.modules = AI_Config.modules or {}
            AI_Config.modules.targettarget = AI_Config.modules.targettarget or {}
            local cfg = AI_Config.modules.targettarget

            -- Frame-Position im Modul auf Default zurücksetzen
            if AI and AI.modules and AI.modules.targettarget and AI.modules.targettarget.ResetPosition then
                AI.modules.targettarget.ResetPosition()
            else
            ...
            -- UI neu initialisieren (setzt die Defaults aus GettargettargetConfig/page.Init)
            if page.Init then
                page.Init()
            end
...
if AI.ConfigUI and AI.ConfigUI.RegisterPage then
    AI.ConfigUI.RegisterPage("targettarget", "targettarget", 40, BuildtargettargetConfigPage)
end